# VIBE-Claude-Plugin Marketing Copy

This file keeps the public positioning consistent across launch posts and repo updates. The default public language is English.
...
Suitable for X, LinkedIn, Discord, and short Reddit comments.

```text
I turned the VIBE engineering workflow into a Claude Code plugin.
...
- run tests, review, and security checks

Repo:
https://github.com/xushuodasd/VIBE-Claude-Plugin
```

## 4. English Launch Post

Suitable for X thread opener, Dev.to intro, Product Hunt draft, or Reddit post body.
...
Document-driven autonomous engineering workflow for Claude Code
...
Keep it within 60 to 90 seconds:

1. Show the repository home page and one-line positioning
2. Show installation
3. Run `/vibe` in Claude Code
4. Show requirement alignment
5. Show generated artifacts such as PRD or `tasks.md`
6. Show coding, testing, and review in motion
7. End with the delivered result and repo URL
