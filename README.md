...
在终端中打开你需要开发的**项目根目录**，启动 Claude Code，并在对话框中直接输入：

```bash
/skill add https://github.com/xushuodasd/VIBE-Claude-Plugin.git
# 或者如果是本地克隆：
# /skill add /path/to/VIBE-Claude-Plugin/skills
```
*(看到 `Added 22 skills` 的提示即代表安装成功)*
